...
namespace ChobiAssets.PTM
{
	...
	public class Static_Track_Parent_CSEditor : Editor
	{
		...
		SerializedProperty Stored_Local_PosProp;
        ...
        void OnEnable ()
		{
			...
			Stored_Local_PosProp = serializedObject.FindProperty("Stored_Local_Pos");
		...
		void Set_Inspector()
		{
            ...
            {
				thisTransform.localPosition = Stored_Local_PosProp.vector3Value;
